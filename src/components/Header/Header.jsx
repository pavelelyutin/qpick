          ...
          <nav className="nav">
            <ul className="nav__list list-reset">
              <li className="nav__item">
                <Link to={PATHS.FAVORITES} className="nav__link" data-count={favoritesCount} aria-label="Избранное">
              ...
              <li className="nav__item">
                <Link to={PATHS.CART} className="nav__link" data-count={cartCount} aria-label="Корзина">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
